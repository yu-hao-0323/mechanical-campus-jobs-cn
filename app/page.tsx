...
const companies: Company[] = [
  ...
  },
  {
    ...
    jobs: [
      ...
      { id: 'nio-stamping-equipment', title: '冲压设备工程师（MF3）', location: '安徽 · 合肥', areas: ['合肥'], degree: '本科及以上', direction: '设备工程', majors: '机械、电气及相关专业', deadline: '校招正式批 · 申请开放', responsibilities: ['参与冲压工艺开发，制定机械、液压、气动专业安装质量标准、验收清单及新设备知识文件', '参与复杂、关键工艺及新设计设备的监造、施工质量监督和专业验收，推动问题解决与经验沉淀', '编制冲压车间机械、液压、气动专业知识文件与 TPM/PM 维护标准，并培训维修人员', '梳理专业备件信息并完成运行备品申购，支持设备体系文件和认证工作', '通过 M-FMEA、PM/TPM 等方式优化设备维护体系，提升 OEE、可靠性和成本控制'], requirements: ['本科及以上，机械、电气及相关专业', '责任感强，具备沟通技巧、团队合作意识和学习能力', '积极乐观、抗压能力强，适应变化能力较好'], url: 'https://nio.jobs.feishu.cn/campus/position/7673026784782715163/detail' },
      { id: 'nio-stamping-process', title: '冲压工艺工程师（MF2）', location: '安徽 · 合肥', areas: ['合肥'], degree: '本科及以上', direction: '制造工程', majors: '机械相关专业', deadline: '校招正式批 · 申请开放', responsibilities: ['参与冲压工艺开发，制定机械、液压、气动安装质量标准、验收清单及新设备知识文件', '参与关键工艺、新设计设备的监造和专业验收，推动实际问题解决', '编制冲压车间机械、液压、气动专业维护标准和备件资料，支持设备体系建设', '运用 M-FMEA、PM/TPM 优化机械、液压、气动维护体系，保障设备可靠加工状态', '推进备件国产化替代、设备技术革新和运行成本优化'], requirements: ['本科及以上，理工科背景', '英语口语及读写能力良好', '熟练使用 Office、AutoCAD、Catia 等软件', '诚信、积极、创新、执行力强，具备团队合作和沟通协调能力', '能够接受高强度工作节奏'], url: 'https://nio.jobs.feishu.cn/campus/position/7673026809440635162/detail' },
    ],
  },
  {
...
const watchlist = [
  ...
  { name: '大众汽车零部件（安徽）', area: '合肥', tag: '外资制造', focus: '动力系统、智能制造、应届生岗位', url: 'https://volkswagenac.com/zh-hans/careers/' },
  { name: '常青股份', area: '合肥', tag: '上市公司', focus: '汽车冲压、车身零部件', url: 'https://www.hfchangqing.com/' },
  { name: '芯碁微装', area: '合肥', tag: '上市公司', focus: '半导体装备、精密机械', url: 'https://www.xinchip.com/' },
  { name: '应流股份', area: '合肥', tag: '上市公司', focus: '高端装备零部件、泵阀', url: 'https://www.yingliugroup.com/' },
  { name: '合肥高科', area: '合肥', tag: '上市公司', focus: '金属模具、冲压件、家电零部件', url: 'https://www.hfgk.com/' },
  { name: '合肥美的暖通', area: '合肥', tag: '上市集团', focus: '暖通装备、研发制造', url: 'https://career.midea.com/' },
  { name: '格力凌达压缩机', area: '合肥', tag: '上市集团', focus: '压缩机、设备与工艺', url: 'https://zp.gree.com/' },
  { name: '合肥万向钱潮', area: '合肥', tag: '上市集团子公司', focus: '汽车底盘、传动轴、制动器', url: 'https://campus.51job.com/wxsz/job.html' },
  { name: '京东方合肥', area: '合肥', tag: '上市集团', focus: '智能制造、设备工程', url: 'https://talent.boe.com/' },
  { name: '埃斯顿自动化', area: '江苏 · 南京', tag: '上市公司', focus: '工业机器人、运动控制', url: 'https://www.estun.com/' },
  { name: '天奇自动化', area: '江苏 · 无锡', tag: '上市公司', focus: '汽车智能装备、机器人', url: 'https://www.chinaconveyor.com/' },
  { name: '隆达超合金', area: '江苏 · 无锡', tag: '上市公司', focus: '高温合金、工艺与设备', url: 'https://www.wxlongda.com/joinus.html' },
  { name: '无锡先导智能', area: '江苏 · 无锡', tag: '上市公司', focus: '锂电智能装备、自动化', url: 'https://www.leadintelligent.com/' },
  { name: '江苏鱼跃医疗', area: '江苏 · 镇江', tag: '上市公司', focus: '医疗器械、智能制造', url: 'https://www.yuwell.com/' },
  { name: '纽威股份', area: '江苏 · 苏州', tag: '上市公司', focus: '工业阀门、流体装备', url: 'https://www.neway.com.cn/' },
  { name: '中天科技', area: '江苏 · 南通', tag: '上市公司', focus: '线缆装备、智能制造', url: 'https://www.chinaztt.com/' },
  { name: '常州比亚迪', area: '江苏 · 常州', tag: '未上市大型企业', focus: '新能源汽车、智能制造', url: 'https://job.byd.com/' },
  { name: '理想汽车常州', area: '江苏 · 常州', tag: '上市车企', focus: '新能源汽车、制造工程', url: 'https://www.lixiang.com/careers' },
  { name: '扬力集团', area: '江苏 · 扬州', tag: '未上市大型企业', focus: '压力机、锻压装备', url: 'https://www.yangli.com/' },
  { name: '杭氧股份', area: '杭州', tag: '上市国企', focus: '空分装备、流程与机械', url: 'https://www.hangyang.com/' },
  { name: '西子洁能', area: '杭州', tag: '上市公司', focus: '能源装备、锅炉与环保', url: 'https://www.xizice.com/' },
  { name: '万向钱潮', area: '杭州', tag: '上市公司', focus: '汽车零部件、传动系统', url: 'https://www.wanxiang.com.cn/' },
  { name: '海亮股份', area: '杭州', tag: '上市公司', focus: '铜加工、智能制造', url: 'https://www.hailiangstock.com/career.html' },
  { name: '新坐标', area: '杭州', tag: '上市公司', focus: '汽车发动机精密零部件', url: 'https://www.xzbco.com/' },
  { name: '飞仕得科技', area: '杭州', tag: '未上市大型企业', focus: '半导体检测、非标自动化', url: 'https://www.fasstech.com/' },
  { name: '日月股份', area: '宁波', tag: '上市公司', focus: '风电铸件、重型装备', url: 'https://www.riyuehi.com/' },
  { name: '金田铜业', area: '宁波', tag: '上市公司', focus: '铜加工、装备与工艺', url: 'https://www.jintian.com/' },
  { name: '舜宇光学', area: '宁波', tag: '上市公司', focus: '光学精密制造、设备工程', url: 'https://www.sunnyoptical.com/' },
  { name: '公牛集团', area: '宁波', tag: '上市公司', focus: '电器制造、自动化', url: 'https://www.gongniu.cn/' },
  { name: '乐惠国际', area: '宁波', tag: '上市公司', focus: '啤酒饮料装备、机械设计', url: 'https://www.lehui.com/' },
  { name: '帅特龙汽车系统', area: '宁波', tag: '未上市大型企业', focus: '汽车电子、内外饰系统', url: 'https://www.nbstl.cn/Index/join2' },
  { name: '宁波港', area: '宁波', tag: '上市国企', focus: '港口装备、机械设备', url: 'https://www.nbport.com.cn/' },
];
...
export default function Home() {
  ...
  const [resumeFields, setResumeFields] = useState<ResumeFields>({ ...emptyResumeFields });
  ...
  useEffect(() => {
    ...
    const { data } = supabase.auth.onAuthStateChange((_event, session) => setResumeUser(session?.user ?? null));
  ...
  const handleResumeFile = async (file: File | null) => {
    if (!file) return;
    if (file.size > 10 * 1024 * 1024) { setResumeMessage('文件不能超过 10 MB。'); return; }
    if (!/\.(pdf|docx|txt)$/i.test(file.name)) { setResumeMessage('仅支持 PDF、DOCX、TXT。'); return; }
    setResumeBusy(true); setResumeMessage('正在本地提取字段…');
    try {
      const text = await extractResumeText(file);
      setResumeFile(file); setResumeText(text); setResumeFields(extractResumeFields(text)); setSelectedResumeId(null);
  ...
  const loadResumeRecords = async () => {
    ...
    const { data, error } = await supabase.from('resume_profiles').select('*').order('created_at', { ascending: false });
    if (error) setResumeMessage(`读取简历库失败：${error.message}`); else setResumeRecords((data ?? []) as ResumeRecord[]);
  };
  const uploadResume = async () => {
    if (!supabase || !resumeUser || !resumeFile) { setResumeMessage('请先登录并选择简历文件。'); return; }
    setResumeBusy(true); setResumeMessage('正在上传私有简历…');
    const safeName = resumeFile.name.replace(/[^a-zA-Z0-9._\-\u4e00-\u9fa5]/g, '_');
  ...
  const saveResumeFields = async () => {
    ...
    setResumeBusy(true);
    const { error } = await supabase.from('resume_profiles').update({ fields: resumeFields, updated_at: new Date().toISOString() }).eq('id', selectedResumeId);
  ...
  const deleteResume = async (record: ResumeRecord) => {
    ...
    setResumeBusy(true);
    const removed = await supabase.storage.from('resumes').remove([record.file_path]);
    const deleted = removed.error ? { error: removed.error } : await supabase.from('resume_profiles').delete().eq('id', record.id);
    setResumeMessage(deleted.error ? `删除失败：${deleted.error.message}` : '简历已删除。');
    ...
    <main className="min-h-screen bg-[#f5f6f2] text-[#14211a]">
      <header className="border-b border-[#dce1da] bg-[#f5f6f2]/95">
        <div className="mx-auto flex max-w-[1180px] items-center justify-between px-5 py-5 sm:px-8">
          ...
          <nav className="hidden items-center gap-4 text-sm text-[#536159] sm:flex"><span>岗位无需登录</span><a href="#resume-vault" className="font-medium text-[#1c6741] hover:underline">{resumeUser ? '我的简历库' : '简历库登录'}</a><a href="#my-list" className="font-medium text-[#1c6741] hover:underline">投递清单 {favorites.size}</a><a href="#standards" className="rounded-full border border-[#aeb8b0] px-4 py-2 font-medium text-[#173f2a] hover:bg-white">收录标准</a></nav>
        </div>
      </header>
            ...
            {filtered.map((company) => {
              ...
              return <article key={company.id} className="overflow-hidden rounded-2xl border border-[#d8dfd9] bg-white shadow-[0_7px_22px_rgba(31,61,42,0.04)]">
                <button onClick={() => toggleCompany(company.id)} aria-expanded={isOpen} className="flex w-full items-center gap-4 p-5 text-left transition hover:bg-[#fbfcf9] sm:p-6">
                  ...
                  <span className="min-w-0 flex-1"><span className="flex flex-wrap items-center gap-2"><strong className="text-xl tracking-tight">{company.name}</strong><span className="rounded-md bg-[#e7eef7] px-2 py-1 text-[11px] font-medium text-[#285277]">{currentCategory(company)}</span><span className="rounded-md bg-[#f4e8de] px-2 py-1 text-[11px] font-medium text-[#a94728]">{company.batch}</span><span className={`rounded-md px-2 py-1 text-[11px] font-medium ${sourceOriginClass}`}>{sourceOrigin}</span>{company.status === 'announcement' && <span className="rounded-md bg-[#fff2c7] px-2 py-1 text-[11px] font-medium text-[#8a5b00]">公告级 · 待补全JD</span>}</span><span className="mt-1.5 block text-sm text-[#6b776f]">{company.industry} · {company.jobs.length} 个匹配岗位</span></span>
      ...
      <section id="resume-vault" className="border-t border-[#dce1da] bg-[#102d20] text-white">
